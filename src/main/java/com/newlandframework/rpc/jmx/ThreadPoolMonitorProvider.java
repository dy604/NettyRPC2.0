 ...
 * @since 2016/10/13
 * Netty线程池监控JMX接口：ThreadPoolMonitorProvider，JMX通过JNDI-RMI的方式进行远程连接通讯
 */

@Configuration //配置类
@EnableMBeanExport //开启注册MBean到JMX实现监控Java运行状态
@ComponentScan("com.newlandframework.rpc.jmx") //Spring实例化扫描包
